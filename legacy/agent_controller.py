# ============================================================================
# LEGACY / DEAD CODE - NOT IMPORTED BY THE RUNNING APP.
# This was the first, hard-coded LangGraph attempt (fixed edges, Pydantic state).
# It was superseded by backend/graph/orchestrator.py (dynamic, LLM-routed graph).
# It does NOT run: it imports `image_prompt_critic` and `image_critic`,
# which do not exist in this repository.
# Kept only to show how the design evolved.
# ============================================================================
