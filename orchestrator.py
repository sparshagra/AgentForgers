...
# from agents import LANGRAPH_AGENT_HANDLERS
# from llm_api import call_llm, call_llm_3
...
#     # "InstagramPostFormatter": ["caption"],
# }
...
#         allowed = reason_json.get("allowed", True)  # default to True for safety
#     except Exception:
#         allowed = True  # if parsing fails, assume allowed
#     return not allowed
