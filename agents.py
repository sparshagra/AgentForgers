...
# )
# from compliance_agent import run_text_compliance, run_image_compliance
# import os
...
#         "memory": memory
#     })
#     caption_text = extract_output(caption_response)
#     print(f"✅ Captioner: Caption created ({len(caption_text)} chars)")

#     critique_response = critic_tool.invoke({
#         "outline": caption_text,
#         "memory": memory
#     })
#     critique_text = extract_output(critique_response)
#     print(f"🧐 Critic: Feedback generated ({len(critique_text)} chars)")
...
#         "memory": memory
#     })
#     refined_caption = extract_output(refined_response)
#     print(f"✅ Captioner (Refined): Caption improved ({len(refined_caption)} chars)")

#     print(f"🧠 Memory STM size: {len(memory.stm)} | Episodic entries: {len(memory.episodic)}")

#     return {**state, "caption": refined_caption, "caption_critique": critique_text}
...
#     from logo_dropper import add_logo_to_image  # <-- NEW IMPORT
...
#     if "caption" in state:
#         context_chunks.append(f"Caption: {state['caption']}")
...
#         "final_image_path": branded_image_path,  # <-- Add this line
#         "final_caption": state.get("caption"),   # <-- Add this line (optional)
#     }

# # agents.py
# # from tools import instagram_post_formatter_tool

# # def instagram_post_formatter_agent(state, memory=None):
# #     enhanced = state.get("enhanced")
# #     outline = state.get("outline")
# #     caption = state.get("caption")
# #     ig_post = instagram_post_formatter_tool(enhanced, outline, caption)
# #     state["ig_post"] = ig_post
# #     if memory:
# #         memory.remember("ig_post_composed", ig_post)
# #     return state
...
def image_generator_agent(state, memory):
    ...
    from logo_dropper import add_logo_to_image
    ...
    logo_path = state.get("logo_path") or "brand_logo.png"
